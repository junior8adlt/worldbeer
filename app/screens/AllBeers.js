...
export default class AllBeers extends Component {
  ...
  componentDidMount() {
    Font.loadAsync({
      ...
      fetch(
        "http://api.brewerydb.com/v2/beers/?key=d24ec48f42cec3e71dbb13fda0517a5b",
        {
          method: "GET"
        }
      )
  ...
  loadMoreData = async () => {
    this.state.page++;
    fetch(
      "http://api.brewerydb.com/v2/beers/?key=d24ec48f42cec3e71dbb13fda0517a5b&p=" +
        this.state.page,
      {
        method: "GET"
      }
      ...
      return (
        <View style={styles.viewBody}>
          <ScrollView style={styles.fixed}  ref={c => {
            ...
            {this.state.fontLoaded == true && this.state.flag !=true ? (
              <Button
                icon={({ size, color }) => (
                  <Image

...
export default class BitterBeers extends Component {
  constructor() {
    super();
    this.state = {
      dataSource: [],
  ...
  componentDidMount() {
    Font.loadAsync({
      ...
      fetch(
        "http://api.brewerydb.com/v2/beers/?key=d24ec48f42cec3e71dbb13fda0517a5b&ibu=70,100",
        {
          method: "GET"
        }
      )
  ...
  loadMoreData = async () => {
    this.state.page++;
    fetch(
      "http://api.brewerydb.com/v2/beers/?key=d24ec48f42cec3e71dbb13fda0517a5b&ibu=70,100&p=" +
        this.state.page,
      {
        method: "GET"
      }
        ...
        componentes.push(
          <Card key={value.id} style={styles.mustaceBg}>
            <Card.Content>
              ...
              <Paragraph style={styles.ibu}>IBU: {value.ibu}</Paragraph>
